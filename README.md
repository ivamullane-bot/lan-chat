...
```bash
curl -O https://raw.githubusercontent.com/ivamullane-bot/lan-chat/main/docker-compose.yml
docker compose up -d
```
...
services:
  lan-chat:
    ...
    restart: always
    network_mode: host
    build: https://github.com/ivamullane-bot/lan-chat.git
    volumes:
      - /vol1/1000/docker/lan-chat/data:/app/data
    environment:
      - LAN_CHAT_ADMIN=admin
      - LAN_CHAT_ADMIN_PASSWORD=admin123
